...
// TestStore 为 store 包测试提供可嵌入的 Store 桩，未覆盖的方法返回零值。
...
func (TestStore) UpdateUser(context.Context, string, UserUpdates) (*User, error) { return nil, nil }
func (TestStore) DeleteUser(context.Context, string) error                       { return nil }
...
func (TestStore) CompleteSuccessCall(context.Context, SuccessQuotaReservation, bool) error {
	return nil
}
...
func (TestStore) UpdateKey(context.Context, string, KeyUpdates) (*APIKey, error) { return nil, nil }
func (TestStore) DeleteKey(context.Context, string) error                        { return nil }
func (TestStore) RecordUsage(context.Context, UsageRecord) error                 { return nil }
